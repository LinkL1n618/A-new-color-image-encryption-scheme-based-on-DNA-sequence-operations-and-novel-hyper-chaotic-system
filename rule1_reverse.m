function [original_cipher_image_row] = rule1_reverse(encoded_cipher_image_row)
    ...
    bin_string = '';
    for i = 1 : iterator
        if char(encoded_cipher_image_row(i)) == 'A'
            bin_string = [bin_string , '00'];
        elseif char(encoded_cipher_image_row(i)) == 'C'
            bin_string = [bin_string , '01'];
        elseif char(encoded_cipher_image_row(i)) == 'G'
