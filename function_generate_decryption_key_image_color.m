function result_image = function_generate_decryption_key_image_color(key1,key2,key3,key4,height ,width)    
N = max(height ,width);
%SHA-256算法转换
name_num=sha512_to_float(sha512(key1,'SHA-512'));
time_num=sha512_to_float(sha512(key2,'SHA-512'));
size_num=sha512_to_float(sha512(key3,'SHA-512'));
...
%新建密钥图矩阵
key_image=zeros(height,width,3);
%生成密钥矩阵
